...
public class BankingSystem {
    public static void main(String[] args){
        System.out.println("\n ------Savings Account-------");
        SavingsAccount sa = new SavingsAccount("HIH3455", 2000, 4.5);
        sa.displayDetails();
        sa.displayAccountType();

        System.out.println("\n------Checking Account---------");
        CheckingAccount ca = new CheckingAccount("FGR234", 10000, 2000);
        ca.displayDetails();
        ca.displayAccountType();

        System.out.println("\n------Fixed Deposit Account--------");
        FixedDepositAccount fda = new FixedDepositAccount("FHR324", 50000,12 );
        fda.displayDetails();
